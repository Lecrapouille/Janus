...
{
    Old = 0,        // Model of the initial project
...
public:
    ...
    static float
        negative_mass_proportion; // Anti-Newton: percentage of negative mass.
    static float step;            // The time step of the simulation.
    static float
        smoothing_length; // The smoothing length of the gravitational force.
     ...
     * @return an array of booleans that are true if the corresponding button
     * was clicked
     */
    static std::vector<bool>
    centered_buttons(const std::vector<std::string> texts,
