...
public:
    ...
    static std::vector<dim::Vector4>
        accelerations;                  // The acceleration of the stars.
    ...
    static cl::Buffer
        accelerations_buffer;      // The OpenCL buffer of the accelerations.
    static cl::Buffer step_buffer; // The OpenCL buffer of the time step.
    static cl::Buffer
        smoothing_length_buffer; // The OpenCL buffer of the smoothing length.
    static cl::Buffer
        interaction_rate_buffer; // The OpenCL buffer of the interaction rate.
    static cl::Buffer black_hole_mass_buffer; // The OpenCL buffer of the mass
                                              // of the black hole.

    /**
     * @brief Gives a point randomly placed in a sphere of the diameter of the
     * galaxy.
     *
     ...
     * galaxy.
     *
     * @return the randomly placed point with randomize positive or negative
     * mass.
     */
    static void random_sphere(const float negative_mass_proportion,
